...
CREATE TABLE [Person] (
	...
	[Role] VARCHAR(8) NOT NULL CHECK ([Role] IN ('Director', 'Actor')), -- DONT KNOW IF THIS IS NEED IT, can a director be an actor ???
...
CREATE TABLE [Character] (
	...
	[Description] VARCHAR(MAX) NOT NULL,
	[Role] VARCHAR(10) NOT NULL CHECK ([Role] IN ('leading', 'supporting', 'background')), --(May i need to create ROLE for the MovieActor relation, to manage the actors that dosent have a character)
